...
function app_start() {
	...
	$tropo->say("http://shannon.gsi.dit.upm.es/roberto/birds_sing.mp3", array("allowSignals"=>array("timeExceeded", "attemptsLimit")));
	$tropo->hangup();
	$tropo->say("FUCK OFF", array("voice"=>"leonor", "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
