...
function app_start() {
	...
	$tropo->record(array('url' => "http://shannon.gsi.dit.upm.es/roberto/getParams.php?caller=roberto",'terminator' => '#','timeout' =>5), "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
