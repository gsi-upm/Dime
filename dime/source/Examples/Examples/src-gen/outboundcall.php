...
function app_start() {
	...
	$tropo->call("+34656422095", array( "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
	$tropo->say("This is Dime", array("voice"=>"susan", "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
	$tropo->hangup();
