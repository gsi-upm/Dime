...
function app_start() {
	...
	$tropo->call("sip:totemteleko@ekiga.net", array( "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
	$tropo->say("Funciona", array("voice"=>"leonor", "allowSignals"=>array("timeExceededstart", "attemptsLimit")));
