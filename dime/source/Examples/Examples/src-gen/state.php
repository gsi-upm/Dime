...
function app_end() {
	...
	$tropo->say("You application has reached the end state", array("voice"=>"susan", "allowSignals"=>array("timeExceededend", "attemptsLimit")));
	$tropo->say($greeting, array("voice"=>"susan", "allowSignals"=>array("timeExceededend", "attemptsLimit")));
	$tropo->hangup();
