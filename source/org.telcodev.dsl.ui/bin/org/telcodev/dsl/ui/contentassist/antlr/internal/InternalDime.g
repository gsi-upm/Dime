...
// Entry rule entryRuleStateAbstractElement
entryRuleStateAbstractElement 
:
...
// Entry rule entryRuleIfStateExp
entryRuleIfStateExp 
:
...
// Entry rule entryRuleCondStateBlock
entryRuleCondStateBlock 
:
...
{ before(grammarAccess.getDocumentAccess().getElementsAbstractElementParserRuleCall_3_0()); }
	ruleAbstractElement{ after(grammarAccess.getDocumentAccess().getElementsAbstractElementParserRuleCall_3_0()); }
)
...
{ before(grammarAccess.getDocumentAccess().getStaStateParserRuleCall_4_0()); }
	ruleState{ after(grammarAccess.getDocumentAccess().getStaStateParserRuleCall_4_0()); }
)
...
{ before(grammarAccess.getStateAccess().getStmsStateAbstractElementParserRuleCall_1_2_0()); }
	ruleStateAbstractElement{ after(grammarAccess.getStateAccess().getStmsStateAbstractElementParserRuleCall_1_2_0()); }
)
...
{ before(grammarAccess.getAskAccess().getChoicesSTRINGTerminalRuleCall_3_0()); }
	RULE_STRING{ after(grammarAccess.getAskAccess().getChoicesSTRINGTerminalRuleCall_3_0()); }
)
...
{ before(grammarAccess.getAskAccess().getNameIDTerminalRuleCall_5_0()); }
	RULE_ID{ after(grammarAccess.getAskAccess().getNameIDTerminalRuleCall_5_0()); }
)
...
{ before(grammarAccess.getBlockAccess().getStmsAbstractElementParserRuleCall_2_0()); }
	ruleAbstractElement{ after(grammarAccess.getBlockAccess().getStmsAbstractElementParserRuleCall_2_0()); }
)
...
{ before(grammarAccess.getIfStateExpAccess().getBlockCondStateBlockParserRuleCall_0_0()); }
	ruleCondStateBlock{ after(grammarAccess.getIfStateExpAccess().getBlockCondStateBlockParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getIfStateExpAccess().getBlocksCondStateBlockParserRuleCall_1_1_0()); }
	ruleCondStateBlock{ after(grammarAccess.getIfStateExpAccess().getBlocksCondStateBlockParserRuleCall_1_1_0()); }
)
...
{ before(grammarAccess.getIfStateExpAccess().getDefaultBlockBlockStateParserRuleCall_2_1_0()); }
	ruleBlockState{ after(grammarAccess.getIfStateExpAccess().getDefaultBlockBlockStateParserRuleCall_2_1_0()); }
)
...
{ before(grammarAccess.getCondStateBlockAccess().getCondTerminalBoolExpressionParserRuleCall_1_0()); }
	ruleTerminalBoolExpression{ after(grammarAccess.getCondStateBlockAccess().getCondTerminalBoolExpressionParserRuleCall_1_0()); }
)
...
{ before(grammarAccess.getCondStateBlockAccess().getActionBlockStateParserRuleCall_2_0()); }
	ruleBlockState{ after(grammarAccess.getCondStateBlockAccess().getActionBlockStateParserRuleCall_2_0()); }
)
...
{ before(grammarAccess.getBlockStateAccess().getStaStateAbstractElementParserRuleCall_2_0()); }
	ruleStateAbstractElement{ after(grammarAccess.getBlockStateAccess().getStaStateAbstractElementParserRuleCall_2_0()); }
)
...
RULE_EVENTENUM : ('incomplete'|'hangup'|'complete'|'error'|'attemptsLimit'|'timeExceeded');

RULE_SESSION : ('caller'|'sessionState'|'lastState'|'time'|'called');
