...
public class DimeAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DimeSwitch<Adapter> modelSwitch =
    new DimeSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseStateAbstractElement(StateAbstractElement object)
      {
        return createStateAbstractElementAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseIfStateExp(IfStateExp object)
      {
        return createIfStateExpAdapter();
      }
      @Override
      public Adapter caseCondStateBlock(CondStateBlock object)
      {
        return createCondStateBlockAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.telcodev.dsl.dime.StateAbstractElement <em>State Abstract Element</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createStateAbstractElementAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.telcodev.dsl.dime.IfStateExp <em>If State Exp</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createIfStateExpAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.telcodev.dsl.dime.CondStateBlock <em>Cond State Block</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCondStateBlockAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.telcodev.dsl.dime.BlockState <em>Block State</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
