...
public class DimePackageImpl extends EPackageImpl implements DimePackage
{
   ...
   * @generated
   */
  private EClass stateAbstractElementEClass = null;
   ...
   * @generated
   */
  private EClass ifStateExpEClass = null;
   ...
   * @generated
   */
  private EClass condStateBlockEClass = null;
   ...
   * @generated
   */
  public EAttribute getDocument_States()
  {
   ...
   * @generated
   */
  public EClass getStateAbstractElement()
  {
    return stateAbstractElementEClass;
  }
   ...
   * @generated
   */
  public EAttribute getAsk_Choices()
  {
  ...
  {
    return (EAttribute)askEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getBlock_Stms()
  {
   ...
   * @generated
   */
  public EClass getIfStateExp()
  {
    return ifStateExpEClass;
  }
   ...
   * @generated
   */
  public EReference getIfStateExp_Block()
  {
    return (EReference)ifStateExpEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getIfStateExp_Blocks()
  {
    return (EReference)ifStateExpEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getIfStateExp_DefaultBlock()
  {
    return (EReference)ifStateExpEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getCondStateBlock()
  {
    return condStateBlockEClass;
  }
   ...
   * @generated
   */
  public EReference getCondStateBlock_Cond()
  {
    return (EReference)condStateBlockEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getCondStateBlock_Action()
  {
    return (EReference)condStateBlockEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getBlockState_Sta()
  {
    return (EReference)blockStateEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(documentEClass, DOCUMENT__STATES);
    ...
    stateAbstractElementEClass = createEClass(STATE_ABSTRACT_ELEMENT);
    ...
    createEAttribute(askEClass, ASK__CHOICES);
    ...
    createEReference(blockEClass, BLOCK__STMS);
    ...
    ifStateExpEClass = createEClass(IF_STATE_EXP);
    createEReference(ifStateExpEClass, IF_STATE_EXP__BLOCK);
    createEReference(ifStateExpEClass, IF_STATE_EXP__BLOCKS);
    createEReference(ifStateExpEClass, IF_STATE_EXP__DEFAULT_BLOCK);

    condStateBlockEClass = createEClass(COND_STATE_BLOCK);
    createEReference(condStateBlockEClass, COND_STATE_BLOCK__COND);
    createEReference(condStateBlockEClass, COND_STATE_BLOCK__ACTION);

    blockStateEClass = createEClass(BLOCK_STATE);
    createEReference(blockStateEClass, BLOCK_STATE__STA);
  ...
  public void initializePackageContents()
  {
    ...
    statementEClass.getESuperTypes().add(this.getStateAbstractElement());
    ...
    transitionEClass.getESuperTypes().add(this.getStateAbstractElement());
    ifExpEClass.getESuperTypes().add(this.getAbstractElement());
    ifStateExpEClass.getESuperTypes().add(this.getStateAbstractElement());
    ...
    initEAttribute(getDocument_States(), ecorePackage.getEBoolean(), "states", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(stateAbstractElementEClass, StateAbstractElement.class, "StateAbstractElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getState_Stms(), this.getStateAbstractElement(), null, "stms", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAsk_Choices(), ecorePackage.getEString(), "choices", null, 0, 1, Ask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getBlock_Stms(), this.getAbstractElement(), null, "stms", null, 0, -1, Block.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(ifStateExpEClass, IfStateExp.class, "IfStateExp", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getIfStateExp_Block(), this.getCondStateBlock(), null, "block", null, 0, 1, IfStateExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIfStateExp_Blocks(), this.getCondStateBlock(), null, "blocks", null, 0, -1, IfStateExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIfStateExp_DefaultBlock(), this.getBlockState(), null, "defaultBlock", null, 0, 1, IfStateExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(condStateBlockEClass, CondStateBlock.class, "CondStateBlock", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCondStateBlock_Cond(), this.getBoolExpression(), null, "cond", null, 0, 1, CondStateBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCondStateBlock_Action(), this.getBlockState(), null, "action", null, 0, 1, CondStateBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(blockStateEClass, BlockState.class, "BlockState", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getBlockState_Sta(), this.getStateAbstractElement(), null, "sta", null, 0, -1, BlockState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
