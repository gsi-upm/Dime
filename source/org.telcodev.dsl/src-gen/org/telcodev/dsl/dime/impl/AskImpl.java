 ...
 *   <li>{@link org.telcodev.dsl.dime.impl.AskImpl#getChoices <em>Choices</em>}</li>
...
public class AskImpl extends VoiceTagImpl implements Ask
{
  ...
  public void setChoices(String newChoices)
  {
    ...
    choices = newChoices;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DimePackage.ASK__CHOICES, oldChoices, choices));
  }
