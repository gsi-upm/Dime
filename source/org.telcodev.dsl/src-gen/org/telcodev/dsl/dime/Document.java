 ...
 *   <li>{@link org.telcodev.dsl.dime.Document#isStates <em>States</em>}</li>
...
public interface Document extends EObject
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>States</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>States</em>' attribute.
   * @see #setStates(boolean)
   * @see org.telcodev.dsl.dime.DimePackage#getDocument_States()
   * @model
   * @generated
   */
  boolean isStates();
  ...
  /**
   * Sets the value of the '{@link org.telcodev.dsl.dime.Document#isStates <em>States</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
