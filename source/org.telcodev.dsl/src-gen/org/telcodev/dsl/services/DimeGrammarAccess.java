...
public class DimeGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DocumentElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cStatesWithStatesKeyword_2_0 = (Keyword)cStatesAssignment_2.eContents().get(0);
		...
		private final Assignment cStaAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cStaStateParserRuleCall_4_0 = (RuleCall)cStaAssignment_4.eContents().get(0);
		
		//Document:
		//	"application" name=ID states?="withStates"? elements+=AbstractElement* sta+=State*;
		...
		//"withStates"
		public Keyword getStatesWithStatesKeyword_2_0() { return cStatesWithStatesKeyword_2_0; }
		...
		//sta+=State*
		public Assignment getStaAssignment_4() { return cStaAssignment_4; }

		//State
		public RuleCall getStaStateParserRuleCall_4_0() { return cStaStateParserRuleCall_4_0; }
	}
	...
	public class AbstractElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cIfExpParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//IfExp
		public RuleCall getIfExpParserRuleCall_1() { return cIfExpParserRuleCall_1; }
	}
	...
	public class StateAbstractElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "StateAbstractElement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cStatementParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cTransitionParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		private final RuleCall cIfStateExpParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		
		//StateAbstractElement:
		//	Statement | Transition | // Repeat | Save
		//	IfStateExp;
		public ParserRule getRule() { return rule; }
		...
		//// Repeat | Save
		//IfStateExp
		public RuleCall getIfStateExpParserRuleCall_2() { return cIfStateExpParserRuleCall_2; }
	}
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cStmsStateAbstractElementParserRuleCall_1_2_0 = (RuleCall)cStmsAssignment_1_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_1_3 = (Keyword)cGroup_1.eContents().get(3);
		
		//State:
		//	"state" name=ID ("times" times=INT)? & ("timeout" timeout=INT)? "{" stms+=StateAbstractElement* "}";
		public ParserRule getRule() { return rule; }
		...
		//("timeout" timeout=INT)? "{" stms+=StateAbstractElement* "}"
		...
		//stms+=StateAbstractElement*
		public Assignment getStmsAssignment_1_2() { return cStmsAssignment_1_2; }

		//StateAbstractElement
		public RuleCall getStmsStateAbstractElementParserRuleCall_1_2_0() { return cStmsStateAbstractElementParserRuleCall_1_2_0; }
	...
	public class VoiceTagElements extends AbstractParserRuleElementFinder {
		...
		////Falta la implementación de una etiqueta conference.
		//VoiceTag:
		//	Say | Dial | Play | Record | GetDigits | Ask | Send | Reject | Hangup;
		public ParserRule getRule() { return rule; }
	...
	public class AskElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cChoicesKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cChoicesAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cChoicesSTRINGTerminalRuleCall_3_0 = (RuleCall)cChoicesAssignment_3.eContents().get(0);
		private final Keyword cHyphenMinusGreaterThanSignKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cNameAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cNameIDTerminalRuleCall_5_0 = (RuleCall)cNameAssignment_5.eContents().get(0);
		private final Keyword cSemicolonKeyword_6 = (Keyword)cGroup.eContents().get(6);
		...
		//Ask:
		//	"ask" question=ConcatenationExpression "choices" choices=STRING "->" name=ID ";";
		public ParserRule getRule() { return rule; }
		...
		//"choices"
		public Keyword getChoicesKeyword_2() { return cChoicesKeyword_2; }

		//choices=STRING
		public Assignment getChoicesAssignment_3() { return cChoicesAssignment_3; }

		//STRING
		public RuleCall getChoicesSTRINGTerminalRuleCall_3_0() { return cChoicesSTRINGTerminalRuleCall_3_0; }
	...
	public class SendElements extends AbstractParserRuleElementFinder {
		...
		////Send:
		////	'sendAs' name=STRING that=ConcatenationExpression 'to' uri=ConcatenationExpression ';'
		////;
		//Send:
	...
	public class ParamElements extends AbstractParserRuleElementFinder {
		...
		////ParamName esta puesto como STRING en vez de ConcatenationExpreesion
		//Param:
	...
	public class BlockElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cStmsAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cStmsAbstractElementParserRuleCall_2_0 = (RuleCall)cStmsAssignment_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		
		//Block:
		//	{Block} "{" stms+=AbstractElement* "}";
		public ParserRule getRule() { return rule; }
		...
		public Assignment getStmsAssignment_2() { return cStmsAssignment_2; }

		//AbstractElement
		public RuleCall getStmsAbstractElementParserRuleCall_2_0() { return cStmsAbstractElementParserRuleCall_2_0; }
	...
	public class IfStateExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "IfStateExp");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cBlockAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cBlockCondStateBlockParserRuleCall_0_0 = (RuleCall)cBlockAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cElseKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cBlocksAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cBlocksCondStateBlockParserRuleCall_1_1_0 = (RuleCall)cBlocksAssignment_1_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cElseKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cDefaultBlockAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cDefaultBlockBlockStateParserRuleCall_2_1_0 = (RuleCall)cDefaultBlockAssignment_2_1.eContents().get(0);
		
		////StateStructure:
		////	IfStateExp
		////;
		//IfStateExp:
		//	block=CondStateBlock ("else" blocks+=CondStateBlock)* ("else" defaultBlock=BlockState)?;
		public ParserRule getRule() { return rule; }

		//block=CondStateBlock ("else" blocks+=CondStateBlock)* ("else" defaultBlock=BlockState)?
		public Group getGroup() { return cGroup; }

		//block=CondStateBlock
		public Assignment getBlockAssignment_0() { return cBlockAssignment_0; }

		//CondStateBlock
		public RuleCall getBlockCondStateBlockParserRuleCall_0_0() { return cBlockCondStateBlockParserRuleCall_0_0; }

		//("else" blocks+=CondStateBlock)*
		public Group getGroup_1() { return cGroup_1; }

		//"else"
		public Keyword getElseKeyword_1_0() { return cElseKeyword_1_0; }

		//blocks+=CondStateBlock
		public Assignment getBlocksAssignment_1_1() { return cBlocksAssignment_1_1; }

		//CondStateBlock
		public RuleCall getBlocksCondStateBlockParserRuleCall_1_1_0() { return cBlocksCondStateBlockParserRuleCall_1_1_0; }

		//("else" defaultBlock=BlockState)?
		public Group getGroup_2() { return cGroup_2; }
		...
		//BlockState
		public RuleCall getDefaultBlockBlockStateParserRuleCall_2_1_0() { return cDefaultBlockBlockStateParserRuleCall_2_1_0; }
	}

	public class CondStateBlockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "CondStateBlock");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cIfKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cCondAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cCondTerminalBoolExpressionParserRuleCall_1_0 = (RuleCall)cCondAssignment_1.eContents().get(0);
		private final Assignment cActionAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cActionBlockStateParserRuleCall_2_0 = (RuleCall)cActionAssignment_2.eContents().get(0);
		
		//CondStateBlock:
		//	"if" cond=TerminalBoolExpression action=BlockState;
		public ParserRule getRule() { return rule; }
		...
		//BlockState
		public RuleCall getActionBlockStateParserRuleCall_2_0() { return cActionBlockStateParserRuleCall_2_0; }
	}

	public class BlockStateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "BlockState");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBlockStateAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cStaAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cStaStateAbstractElementParserRuleCall_2_0 = (RuleCall)cStaAssignment_2.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		
		//BlockState:
		//	{BlockState} "{" sta+=StateAbstractElement* "}";
		public ParserRule getRule() { return rule; }
		...
		//{BlockState}
		public Action getBlockStateAction_0() { return cBlockStateAction_0; }
		...
		//StateAbstractElement
		public RuleCall getStaStateAbstractElementParserRuleCall_2_0() { return cStaStateAbstractElementParserRuleCall_2_0; }
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		...
		////ForExp:
		////	'for' '(' var=Variable ';' cond=BoolExpression  ';' stm= Assigment')'
		////	block=Block
		////;
		////Event:
		////	'event' name=ID 'when' cond=BoolExpression
		////;
		////
		////AbstractEvent:
		////	EventEnum | name=[Event] 
		////	
		////;
		//Number:
		//	DOUBLE | INT;
	...
	private StateAbstractElementElements pStateAbstractElement;
	...
	private IfStateExpElements pIfStateExp;
	private CondStateBlockElements pCondStateBlock;
	private BlockStateElements pBlockState;
	...
	//	Statement | Transition | // Repeat | Save
	//	IfStateExp;
	public StateAbstractElementElements getStateAbstractElementAccess() {
		return (pStateAbstractElement != null) ? pStateAbstractElement : (pStateAbstractElement = new StateAbstractElementElements());
	}
	
	public ParserRule getStateAbstractElementRule() {
		return getStateAbstractElementAccess().getRule();
	}
	...
	//IfStateExp:
	//	block=CondStateBlock ("else" blocks+=CondStateBlock)* ("else" defaultBlock=BlockState)?;
	public IfStateExpElements getIfStateExpAccess() {
		return (pIfStateExp != null) ? pIfStateExp : (pIfStateExp = new IfStateExpElements());
	}
	
	public ParserRule getIfStateExpRule() {
		return getIfStateExpAccess().getRule();
	}

	//CondStateBlock:
	//	"if" cond=TerminalBoolExpression action=BlockState;
	public CondStateBlockElements getCondStateBlockAccess() {
		return (pCondStateBlock != null) ? pCondStateBlock : (pCondStateBlock = new CondStateBlockElements());
	}
	
	public ParserRule getCondStateBlockRule() {
		return getCondStateBlockAccess().getRule();
	}

	//BlockState:
	//	{BlockState} "{" sta+=StateAbstractElement* "}";
	public BlockStateElements getBlockStateAccess() {
		return (pBlockState != null) ? pBlockState : (pBlockState = new BlockStateElements());
	}
	...
	//// Terminals
	//terminal EventEnum:
	//	"incomplete" | "hangup" | "complete" | "error" | "attemptsLimit" | // 'TOKEN'
	//	"timeExceeded";
	...
	//terminal SESSION:
	//	"caller" | "sessionState" | "lastState" | "time" | "called";
