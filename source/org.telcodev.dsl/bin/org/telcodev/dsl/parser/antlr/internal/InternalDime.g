...
entryRuleStateAbstractElement returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getStateAbstractElementRule()); }
	 iv_ruleStateAbstractElement=ruleStateAbstractElement 
	 { $current=$iv_ruleStateAbstractElement.current; } 
	 EOF 
;

// Rule StateAbstractElement
ruleStateAbstractElement returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_IfStateExp_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleIfStateExp returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getIfStateExpRule()); }
	 iv_ruleIfStateExp=ruleIfStateExp 
	 { $current=$iv_ruleIfStateExp.current; } 
	 EOF 
;

// Rule IfStateExp
ruleIfStateExp returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleCondStateBlock returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCondStateBlockRule()); }
	 iv_ruleCondStateBlock=ruleCondStateBlock 
	 { $current=$iv_ruleCondStateBlock.current; } 
	 EOF 
;

// Rule CondStateBlock
ruleCondStateBlock returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='if' 
